...
for ID in training_set_IDs:
	print(ID, end='\r')
	location = '/data/chercheurs/qureshi191/preprocessed_data/training_data/text/USE_transformer_embeddings/individual_embeddings/'+str(ID)+'.npy'
	a = np.load(location)
	a = a.T
...
np.save('/data/chercheurs/qureshi191/preprocessed_data/training_data/text/USE_transformer_embeddings/USE_transformer.npy', X)