...
for ID in dev_set_ID_list:
	...
	data = pd.read_csv('/data/chercheurs/qureshi191/raw_data/'+str(ID)+'_P/'+str(ID)+'_CLNF_gaze.txt', sep=', ')
	...
	np.save('/data/chercheurs/qureshi191/preprocessed_data/development_data/visual/eye_gaze/individual/'+str(ID)+'_eye_gaze.npy', data_array)
